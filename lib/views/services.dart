...
List items = [
  ...
  Items(
    title: 'MACHINE LEARNING', desc: "Machine learning is an application of Artificial Intelligence (AI) that provides systems the ability to automatically learn and improve from experience without being explicitly programmed. Machine learning focuses on the development of computer programs that can access data and use it to learn for themselves."
  ),
   Items(
    title: 'WEB DEVELOPMENT', desc: "Despite being a centre for data analytics we don't just restrict our domain to big data analytics. We try to excel in every domain and thus we have members who are excellent web developers. We build websites and web applications based on the latest technologies in the market and using minimum resources."
  ),
   Items(
    title: 'COMPETITIVE CODING', desc: "Competitive programming is a mind sport usually held over the Internet or a local network, involving participants trying to program according to provided specifications. Competitive programming is recognized and supported by several multinational companies such as Google and Facebook."
  ),
   Items(
    title: 'APP DEVELOPMENT', desc: "A phone without good apps is like a bird without wing. Mobile apps reduce our work and help us in many different ways whether it is education, entertainment or paying grocery bills and in many more things. We at Big Data Centre of Excellence have experts who can develop apps for both android and Ios devices."
  ),
];
...
Widget _description(
 DarkThemeProvider themeProvider ,context,
) {
            ...
            return Padding(
              ...
              child: new Container(
                  ...
                  decoration: BoxDecoration(
                        color: themeProvider.darkTheme?Color(0xff3972CF):Color(0xff3972CF),
//                        border: Border(bottom: BorderSide(width: 1.0)),
               ...
               child:         themeProvider.darkTheme? Text(items[index].title,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.black
               ),):Text(items[index].title,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.white),),
                            ),
                             Padding(padding: EdgeInsets.all(25),
               child:   themeProvider.darkTheme? Text(items[index].desc,style: TextStyle(fontSize: 15,color: Colors.black),textAlign: TextAlign.justify,):Text(items[index].desc,style: TextStyle(color:Colors.white,fontSize: 15),textAlign: TextAlign.justify,),
                            )
                          ],),
              ),
            );
         ...
         // control: new SwiperControl(),
             ...
             Row(
               children: <Widget>[
                 ...
                 Padding(padding: EdgeInsets.only(top:9,left:15,right:3),
                  child: CircleAvatar(
                    backgroundColor: Theme.of(context).primaryColor,
                    child: Image.asset('assets/logo.png'),
                  )
                 ),
                  Padding(padding: EdgeInsets.only(top:9,left:5,right:15),
                  child: Text('Powered by Big Data of Excellence',style: TextStyle(
                    fontSize: 15,
